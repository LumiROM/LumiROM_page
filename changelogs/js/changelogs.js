...
// Compiled from /changelogs/ directory in the repository.
...
const CHANGELOGS = [
    ...
    },
    {
        ...
        sections: {
            ...
            more: [
                'Removed Samsung Messages and replaced with Google Messages.'
            ],
            bugs: ['You tell me.']
        }
    },
    ...
    },
    {
        ...
        sections: {
            fixes: [
                'Fixed RIL.',
                'Fixed Camera (almost).',
                'Fixed SSRM (background crash).',
                'Fixed NFC.',
                'Fixed FOD.'
            ],
            more: [
                'First One UI 8.5 from A34 base. Expect bugs, but should be suitable for daily use.'
            ],
            bugs: [
                'Some camera modes like portrait are not working.',
                'You tell me.'
            ]
        }
    },
    {
        ...
        sections: {
            fixes: [
                'Fixed recent calls on Phone app.',
                'Fixed Studio app.'
            ],
            features: [
                'Removed FRP.',
                'Added AI Weather on Lockscreen.',
                'Added AI Wallpaper.',
                'Added new game settings.'
            ],
            more: [
                'LumiVENDOR is now mandatory — keep it on storage until a new update comes out.',
                'Report bugs on the bug theme on the group.'
            ],
    ...
    },
    {
        ...
        sections: {
            fixes: [
                'Fixed Now Brief.',
                'Fixed clock selection on lockscreen.'
            ],
            features: [
    ...
    },
    {
        ...
        sections: {
            ...
            more: [
                'Added support for: A325FXXSCDYB2, A325FXXSCDXL2, A325FXXS7DWL1, A325MUBSBDYC2, M325FVXXSCDYD1.'
            ]
        }
    },
    {
        ...
        sections: {
            fixes: [
                ...
                'Fixed One UI Home crash (again).'
            ],
            features: [
                'Added Edge Panel as launcher fix.',
                'Added new up_param.'
            ]
        }
    },
    {
        ...
        sections: {
            fixes: [
                'Fixed One UI Home crash.',
                'Fixed some background crashes.',
                'First attempt to fix battery backup — should be way better now.'
            ],
    ...
    },
    {
        ...
        sections: {
            fixes: [
                ...
                'Wallpaper change.',
                'NFC.',
                'Basic features like Wi-Fi and Bluetooth.',
                'Lag on security settings.'
            ],
            bugs: [
                'SSRM warning (hard to fix).',
                'Some things can lag.',
                'Can\'t change system sounds volume.'
            ],
            more: [
                'FORMAT DATA required.',
                'First One UI 8 port. Not fully intended for daily usage — most annoying issue is system volume.'
            ]
        }
    }
];
...
const SECTION_META = {
    ...
    features:     { label: 'New Features',   icon: '✨', color: '#6366f1' },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    CHANGELOGS.forEach((cl, idx) => {
        ...
        item.innerHTML = `
            <span class="cl-item-version">${tagHtml}${cl.version}</span>
    ...
    const toggleBtn = document.getElementById('cl-sidebar-toggle');
    const sidebarEl = document.getElementById('cl-sidebar-wrap');
    if (toggleBtn && sidebarEl) {
        toggleBtn.addEventListener('click', () => {
            sidebarEl.classList.toggle('open');
            toggleBtn.textContent = sidebarEl.classList.contains('open') ? '✕ Close' : '☰ Versions';
        });
    }
